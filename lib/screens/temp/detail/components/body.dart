...
class Body extends StatefulWidget {
  Map dict;
  Body({super.key, required this.dict});
  @override
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Container(
                    margin: EdgeInsets.only(
                        right: getProportionateScreenWidth(context, 56)),
                    decoration: const BoxDecoration(
                  ...
                  Column(
                    ...
                    children: [
                      SizedBox(
                        height: getProportionateScreenHeight(context, 360),
                      ),
                      Row(
                        children: [
                          SizedBox(
                          ...
                          //         horizontal:
                          //             getProportionateScreenHeight(context,15)),
                          //     child: Center(
                          //         child: Text(
                          //       "FootBall",
                          //       style: TextStyle(
              ...
              GestureDetector(
                ...
                child: Container(
                  width: getProportionateScreenWidth(context, 180),
                  height: getProportionateScreenHeight(context, 50),
                  padding: EdgeInsets.symmetric(
      ...
      Positioned(
        width: getProportionateScreenWidth(context, 56),
        right: 0,
        child: const Image(image: AssetImage("assets/images/rightbar.png")),
      ),
      Padding(
        padding: EdgeInsets.all(getProportionateScreenHeight(context, 20)),
        child: Align(
      ...
      Padding(
        padding:
            EdgeInsets.only(bottom: getProportionateScreenHeight(context, 20)),
        child: Align(
      ...
      // Align(alignment: Alignment.topRight,child: Icon(Icons.menu,size: getProportionateScreenWidth(context,30),),),
    ]);
  }
}
