...
class _BodyState extends State<Body> {
  ...
  List<Map> sampleUsers = [
    {
      "image": "assets/images/hardik.jpeg",
      "name": "Hardik Singhal",
      "course": "CSE",
      "yog": "2025",
      "number": "9710091598",
  ...
  We are going to be a hit from the start if you're like me too and enjoy exploring different stuff.""",
      ...
      "interest1": "Coding",
      "interest2": "Acting",
      "instaId": "https://www.instagram.com/_ig.hardik/",
      "snapchatId": "https://www.facebook.com/hardik.singhal/",
      "linkedinId": "https://www.linkedin.com/in/hardik-singhal-hs07/",
    },
    {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                  height: getProportionateScreenHeight(context, 310),
                  child: Swiper(
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                    vertical: getProportionateScreenWidth(context, 10),
                    horizontal: getProportionateScreenHeight(context, 10)),
                child: Text(
                  "#YourBatchmates 🎓",
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
              ...
              SizedBox(
                width: getProportionateScreenWidth(context, 320),
                height: getProportionateScreenHeight(context, 130),
                          ...
                          child: Stack(
                            children: [
                              ...
                              Align(
                                ...
                                child: Container(
                                  height:
                                      getProportionateScreenHeight(context, 40),
